...
function animateContent(direction) {  
    var animationOffset = $('body').height() - $('.move').height()-100;
    if (direction == 'up') {
        animationOffset = 0;
    }
    console.log("animationOffset:"+animationOffset);
    $('.move').animate({ "marginTop": (animationOffset)+ "px" }, 5000);
}
function up(){
    animateContent("up")
}
...
var images = ["parsonsmajorstudiofinal2017-02.jpg",
"parsonsmajorstudiofinal2017-03.jpg",
"parsonsmajorstudiofinal2017-04.jpg",
"parsonsmajorstudiofinal2017-05.jpg",
"parsonsmajorstudiofinal2017-06.jpg",
"parsonsmajorstudiofinal2017-07.jpg",
"parsonsmajorstudiofinal2017-08.jpg",
"parsonsmajorstudiofinal2017-09.jpg",
"parsonsmajorstudiofinal2017-10.jpg"];
