...
function setLayerOpacity(layer) {
    ...
    if (LAYERSALL.includes(layer.layer)) {
        document.getElementById('features').style.opacity = layer.opacity;
    }
}
...
map.on("load", function() {
    ...
    map.addLayer({
        ...
        source: {
            ...
            //data: './data/collisions1601.geojson'  //nyc collisions data
        },
        paint: {
            'circle-radius': [
            'interpolate',
